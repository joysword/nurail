...
treeHierarchyData=[
{ id: 'root', name:'Layers'},
	{id:'tr', name:'Transit Routes', parent:'root'},
		{id:'ctr', name:'CTA Train Routes', parent:'tr'},
			{id:'cbl', name:'CTA Blue Line', parent:'ctr'},
			{id:'cbl', name:'CTA Brown Line', parent:'ctr'},
			{id:'cgl', name:'CTA Green Line', parent:'ctr'},
			{id:'col', name:'CTA Orange Line', parent:'ctr'},
			{id:'cpl', name:'CTA Pink Line', parent:'ctr'},
			{id:'cpl', name:'CTA Purple Line', parent:'ctr'},
			{id:'crl', name:'CTA Red Line', parent:'ctr'},
			{id:'cyl', name:'CTA Yellow Line', parent:'ctr'},
		{id:'ml', name:'Metra Lines', parent:'tr'},
